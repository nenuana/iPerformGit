...
@WebServlet(
        urlPatterns = {"/doInsertObiectivClienti"}
)
public class DoInsertObiectivClienti extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoInsertObiectivClienti() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            try {
                ...
                String OBJECTIVE_NAME_CLIENTI= request.getParameter("numeobiectivclienti");
                String objective_description= request.getParameter("descriereclienti");
                String objective_target= request.getParameter("preconizatclienti");
                double preconizat = 0;
                try{
                ...
                String rezult_value= request.getParameter("realizatclienti");
                double realizat = 0;
                try{
              ...
              //  String updateclienti = "updateclienti";
              //  session.setAttribute("updateclienti",updateclienti);

                session.setAttribute("objective_name_clienti",OBJECTIVE_NAME_CLIENTI);
                ObiectiveCentrala obiectiveCentrala = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter,year,marcas,OBJECTIVE_NAME_CLIENTI,objective_description,objectivezone,preconizat);
                ObiectiveCentrala obiectiveCentrala2 = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter2,year,marcas,OBJECTIVE_NAME_CLIENTI,objective_description,objectivezone,preconizat);
                ObiectiveCentrala obiectiveCentrala3 = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter3,year,marcas,OBJECTIVE_NAME_CLIENTI,objective_description,objectivezone,preconizat);
                ObiectiveCentrala obiectiveCentrala4 = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter4,year,marcas,OBJECTIVE_NAME_CLIENTI,objective_description,objectivezone,preconizat);
