...
@WebServlet(
        urlPatterns = {"/doUpdateOameni"}
)
public class DoUpdateOameni extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoUpdateOameni() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            try {
                ...
                String objective_description = request.getParameter("OBJECTIVE_DESCRIPTION_OAMENI" + iduri.get(0).toString());
                System.out.println("obdesc" + objective_description);
                String OBJECTIVE_TARGET_DOUBLE = request.getParameter("OBJECTIVE_TARGET_OAMENI"+ iduri.get(0).toString());

                double objective_target =  Double.parseDouble(OBJECTIVE_TARGET_DOUBLE);
                System.out.println("OBJ TARGET double" + objective_target);
                String RESULT_VALUE_DOUBLE = request.getParameter("RESULT_VALUE_OAMENI"+ iduri.get(0).toString());
                double result_value = Double.parseDouble(RESULT_VALUE_DOUBLE);
                String OBJECTIVE_NAME_OAMENI = request.getParameter("OBJECTIVE_NAME_OAMENI"+ iduri.get(0).toString());
                String SATISFACTION_RATE_DOUBLE = request.getParameter("procentq1oameni"+ iduri.get(0).toString());
                ...
                obiectiveCentrala.setOBJECTIVE_NAME(OBJECTIVE_NAME_OAMENI);
                obiectiveCentrala.setSATISFACTION_RATE(satisfaction_rate);


                String objective_description2 = request.getParameter("OBJECTIVE_DESCRIPTION_OAMENI"+ iduri.get(1).toString());
                String OBJECTIVE_TARGET_DOUBLE2 = request.getParameter("OBJECTIVE_TARGET_OAMENI"+ iduri.get(1).toString());
                double objective_target2 =  Double.parseDouble(OBJECTIVE_TARGET_DOUBLE2);
                String RESULT_VALUE_DOUBLE2 = request.getParameter("RESULT_VALUE_OAMENI"+ iduri.get(1).toString());
                double result_value2 = Double.parseDouble(RESULT_VALUE_DOUBLE2);
                String OBJECTIVE_NAME_OAMENI2 = request.getParameter("OBJECTIVE_NAME_OAMENI"+ iduri.get(1).toString());
                String SATISFACTION_RATE_DOUBLE2 = request.getParameter("procentq1oameni"+ iduri.get(1).toString());
                ...
                obiectiveCentrala2.setOBJECTIVE_NAME(OBJECTIVE_NAME_OAMENI2);
                obiectiveCentrala2.setSATISFACTION_RATE(satisfaction_rate2);



                String objective_description3 = request.getParameter("OBJECTIVE_DESCRIPTION_OAMENI" + iduri.get(2).toString());
                String OBJECTIVE_TARGET_DOUBLE3 = request.getParameter("OBJECTIVE_TARGET_OAMENI"+ iduri.get(2).toString());
                ...
                String RESULT_VALUE_DOUBLE3 = request.getParameter("RESULT_VALUE_OAMENI"+ iduri.get(2).toString());
                double result_value3 = Double.parseDouble(RESULT_VALUE_DOUBLE3);
                String OBJECTIVE_NAME_OAMENI3 = request.getParameter("OBJECTIVE_NAME_OAMENI"+ iduri.get(2).toString());
                String SATISFACTION_RATE_DOUBLE3 = request.getParameter("procentq1oameni"+ iduri.get(2).toString());
                ...
                obiectiveCentrala3.setOBJECTIVE_NAME(OBJECTIVE_NAME_OAMENI3);
                obiectiveCentrala3.setSATISFACTION_RATE(satisfaction_rate3);


                String objective_description4 = request.getParameter("OBJECTIVE_DESCRIPTION_OAMENI"+ iduri.get(3).toString());
                String OBJECTIVE_TARGET_DOUBLE4 = request.getParameter("OBJECTIVE_TARGET_OAMENI"+ iduri.get(3).toString());
                double objective_target4 =  Double.parseDouble(OBJECTIVE_TARGET_DOUBLE4);
                String RESULT_VALUE_DOUBLE4 = request.getParameter("RESULT_VALUE_OAMENI"+ iduri.get(3).toString());
                double result_value4 = Double.parseDouble(RESULT_VALUE_DOUBLE4);
                String OBJECTIVE_NAME_OAMENI4 = request.getParameter("OBJECTIVE_NAME_OAMENI"+ iduri.get(3).toString());
                String SATISFACTION_RATE_DOUBLE4 = request.getParameter("procentq1oameni"+ iduri.get(3).toString());
                ...
                obiectiveCentrala4.setOBJECTIVE_NAME(OBJECTIVE_NAME_OAMENI4);
                ...
                int IDO = Integer.parseInt(idp);
                int IDO2 = Integer.parseInt(idp2);

                System.out.println("cod3" + idp3);
                System.out.println("cod4" + idp4);
                int IDO3 = Integer.parseInt(idp3);
                int IDO4 = Integer.parseInt(idp4);


                try {

                    DBUtilis.updateOameni(conn,obiectiveCentrala,marca,IDO);
                    DBUtilis.updateOameni(conn,obiectiveCentrala2,marca,IDO2);
                    DBUtilis.updateOameni(conn,obiectiveCentrala3,marca,IDO3);
                    DBUtilis.updateOameni(conn,obiectiveCentrala4,marca,IDO4);
