...
@WebServlet(
        urlPatterns = {"/doUpdateProcese"}
)
public class DoUpdateProcese extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoUpdateProcese() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            try {
                ...
                try {
                    id =  DBUtilis.obiectiveprocesenume(conn,marca,objective_name_procese);
                ...
                String objective_description = request.getParameter("OBJECTIVE_DESCRIPTION_PROCESE" + iduri.get(0).toString());
                String OBJECTIVE_TARGET_DOUBLE = request.getParameter("OBJECTIVE_TARGET_PROCESE"+ iduri.get(0).toString());
                System.out.println("OBJ TARGET PROCESE" + OBJECTIVE_TARGET_DOUBLE);
                double objective_target =  Double.parseDouble(OBJECTIVE_TARGET_DOUBLE);
                System.out.println("OBJ TARGET double" + objective_target);
                String RESULT_VALUE_DOUBLE = request.getParameter("RESULT_VALUE_PROCESE"+ iduri.get(0).toString());
                double result_value = Double.parseDouble(RESULT_VALUE_DOUBLE);
                String OBJECTIVE_NAME_PROCESE = request.getParameter("OBJECTIVE_NAME_PROCESE"+ iduri.get(0).toString());
                String SATISFACTION_RATE_DOUBLE = request.getParameter("procentq1procese"+ iduri.get(0).toString());
                ...
                obiectiveCentrala.setOBJECTIVE_NAME(OBJECTIVE_NAME_PROCESE);
                obiectiveCentrala.setSATISFACTION_RATE(satisfaction_rate);


                String objective_description2 = request.getParameter("OBJECTIVE_DESCRIPTION_PROCESE"+ iduri.get(1).toString());
                String OBJECTIVE_TARGET_DOUBLE2 = request.getParameter("OBJECTIVE_TARGET_PROCESE"+ iduri.get(1).toString());
                double objective_target2 =  Double.parseDouble(OBJECTIVE_TARGET_DOUBLE2);
                String RESULT_VALUE_DOUBLE2 = request.getParameter("RESULT_VALUE_PROCESE"+ iduri.get(1).toString());
                double result_value2 = Double.parseDouble(RESULT_VALUE_DOUBLE2);
                String OBJECTIVE_NAME_PROCESE2 = request.getParameter("OBJECTIVE_NAME_PROCESE"+ iduri.get(1).toString());
                String SATISFACTION_RATE_DOUBLE2 = request.getParameter("procentq1procese"+ iduri.get(1).toString());
                ...
                obiectiveCentrala2.setOBJECTIVE_NAME(OBJECTIVE_NAME_PROCESE2);
                obiectiveCentrala2.setSATISFACTION_RATE(satisfaction_rate2);



                String objective_description3 = request.getParameter("OBJECTIVE_DESCRIPTION_PROCESE" + iduri.get(2).toString());
                String OBJECTIVE_TARGET_DOUBLE3 = request.getParameter("OBJECTIVE_TARGET_PROCESE"+ iduri.get(2).toString());
                System.out.println("OBJ TARGET PROCESE3" + OBJECTIVE_TARGET_DOUBLE3);
                ...
                String RESULT_VALUE_DOUBLE3 = request.getParameter("RESULT_VALUE_PROCESE"+ iduri.get(2).toString());
                double result_value3 = Double.parseDouble(RESULT_VALUE_DOUBLE3);
                String OBJECTIVE_NAME_PROCESE3 = request.getParameter("OBJECTIVE_NAME_PROCESE"+ iduri.get(2).toString());
                String SATISFACTION_RATE_DOUBLE3 = request.getParameter("procentq1procese"+ iduri.get(2).toString());
                ...
                obiectiveCentrala3.setOBJECTIVE_NAME(OBJECTIVE_NAME_PROCESE3);
                obiectiveCentrala3.setSATISFACTION_RATE(satisfaction_rate3);


                String objective_description4 = request.getParameter("OBJECTIVE_DESCRIPTION_PROCESE"+ iduri.get(3).toString());
                String OBJECTIVE_TARGET_DOUBLE4 = request.getParameter("OBJECTIVE_TARGET_PROCESE"+ iduri.get(3).toString());
                double objective_target4 =  Double.parseDouble(OBJECTIVE_TARGET_DOUBLE4);
                String RESULT_VALUE_DOUBLE4 = request.getParameter("RESULT_VALUE_PROCESE"+ iduri.get(3).toString());
                double result_value4 = Double.parseDouble(RESULT_VALUE_DOUBLE4);
                String OBJECTIVE_NAME_PROCESE4 = request.getParameter("OBJECTIVE_NAME_PROCESE"+ iduri.get(3).toString());
                String SATISFACTION_RATE_DOUBLE4 = request.getParameter("procentq1procese"+ iduri.get(3).toString());
                ...
                obiectiveCentrala4.setOBJECTIVE_NAME(OBJECTIVE_NAME_PROCESE4);
              ...
              //  session.setAttribute("updateprocese",updateprocese);
                ...
                try {
                    ...
                    DBUtilis.updateProcese(conn,obiectiveCentrala,marca,IDP);
                    DBUtilis.updateProcese(conn,obiectiveCentrala2,marca,IDP2);
                    DBUtilis.updateProcese(conn,obiectiveCentrala3,marca,IDP3);
                    DBUtilis.updateProcese(conn,obiectiveCentrala4,marca,IDP4);
