...
@WebServlet(
        urlPatterns = {"/doInsertObiectivInvatare"}
)
public class DoInsertObiectivInvatare extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoInsertObiectivInvatare() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            try {
                ...
                String OBJECTIVE_NAME_INVATARE= request.getParameter("numeobiectivinvatare");
                String objective_description= request.getParameter("descriereinvatare");
                String objective_target= request.getParameter("preconizatinvatare");
                double preconizat = 0;
                try{
                ...
                String rezult_value= request.getParameter("realizatinvatare");
                double realizat = 0;
                try{
                ...
                ObiectiveCentrala obiectiveCentrala = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter,year,marcas,OBJECTIVE_NAME_INVATARE,objective_description,objectivezone,preconizat);
                ObiectiveCentrala obiectiveCentrala2 = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter2,year,marcas,OBJECTIVE_NAME_INVATARE,objective_description,objectivezone,preconizat);
                ObiectiveCentrala obiectiveCentrala3 = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter3,year,marcas,OBJECTIVE_NAME_INVATARE,objective_description,objectivezone,preconizat);
                ObiectiveCentrala obiectiveCentrala4 = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter4,year,marcas,OBJECTIVE_NAME_INVATARE,objective_description,objectivezone,preconizat);
