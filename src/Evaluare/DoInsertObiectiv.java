...
@WebServlet(
        urlPatterns = {"/doInsertObiectiv"}
)
public class DoInsertObiectiv extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoInsertObiectiv() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            try {
                ...
                String OBJECTIVE_NAME= request.getParameter("numeobiectiv");
                String objective_description= request.getParameter("descriere");
                String objective_target= request.getParameter("preconizat");
                double preconizat = 0;
                try{
                ...
                String rezult_value= request.getParameter("realizat");
                double realizat = 0;
                try{
