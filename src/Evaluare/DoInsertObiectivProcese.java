...
@WebServlet(
        urlPatterns = {"/doInsertObiectivProcese"}
)
public class DoInsertObiectivProcese extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoInsertObiectivProcese() {
    }
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            try {
              ...
              //  session.setAttribute("updateprocese",updateprocese);
                ...
                ObiectiveCentrala obiectiveCentrala2 = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter2,year,marcas,OBJECTIVE_NAME_PROCESE,objective_description,objectivezone,preconizat);
                ObiectiveCentrala obiectiveCentrala3 = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter3,year,marcas,OBJECTIVE_NAME_PROCESE,objective_description,objectivezone,preconizat);
                ObiectiveCentrala obiectiveCentrala4 = new ObiectiveCentrala(realizat,SATISFACTIONRATE,RUNRATE,quarter4,year,marcas,OBJECTIVE_NAME_PROCESE,objective_description,objectivezone,preconizat);
