...
public class ObiectiveRetea {
    private int ID;
    private double RESULT_VALUE;
    private double SATISFCTION_RATE;
    ...
    public ObiectiveRetea(){

    }

    public ObiectiveRetea(int ID,double RESULT_VALUE,double SATISFCTION_RATE,double RUN_RATE,int QUARTER,int YEAR, String ENTITY_ID_OR_MARCA,String OBJECTIVE_NAME, String OBJECTIVE_DESCRIPTION,String OBJECTIVE_ZONE, double OBJECTIVE_TARGET){
        this.ID =ID;
        this.RESULT_VALUE = RESULT_VALUE;
        this.SATISFCTION_RATE = SATISFCTION_RATE;
    ...
    public void setSATISFCTION_RATE(double SATISFCTION_RATE) {
        this.SATISFCTION_RATE = SATISFCTION_RATE;
    }
    ...
    public double getSATISFCTION_RATE() {
        return SATISFCTION_RATE;
    }
