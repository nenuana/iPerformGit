...
@WebServlet(
        urlPatterns = {"/doDeleteProcese"}
)
public class DoDeleteProcese extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoDeleteProcese() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            try {
                ...
                try {
                    DBUtilis.deleteObiectivProcese(conn, marca, IDP);
                    DBUtilis.deleteObiectivProcese(conn, marca, IDP2);
                    DBUtilis.deleteObiectivProcese(conn, marca, IDP3);
                    DBUtilis.deleteObiectivProcese(conn, marca, IDP4);
                ...
                List lista =  DBUtilis.numeprocese(conn,marca);
                ...
                session.setAttribute("objective_name_procese",ob_name);
