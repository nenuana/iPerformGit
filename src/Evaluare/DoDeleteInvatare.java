...
@WebServlet(
        urlPatterns = {"/doDeleteInvatare"}
)
public class DoDeleteInvatare extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoDeleteInvatare() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            try {
                ...
                try {
                    DBUtilis.deleteObiectivInvatare(conn, marca, IDP);
                    DBUtilis.deleteObiectivInvatare(conn, marca, IDP2);
                    DBUtilis.deleteObiectivInvatare(conn, marca, IDP3);
                    DBUtilis.deleteObiectivInvatare(conn, marca, IDP4);
                ...
                List lista =  DBUtilis.numeinvatare(conn,marca);
                ...
                session.setAttribute("objective_name_invatare",ob_name);
