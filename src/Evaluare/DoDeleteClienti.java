...
@WebServlet(
        urlPatterns = {"/doDeleteClienti"}
)
public class DoDeleteClienti extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoDeleteClienti() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            try {
                ...
                try {
                    DBUtilis.deleteObiectivClienti(conn, marca, IDP);
                    DBUtilis.deleteObiectivClienti(conn, marca, IDP2);
                    DBUtilis.deleteObiectivClienti(conn, marca, IDP3);
                    DBUtilis.deleteObiectivClienti(conn, marca, IDP4);
                ...
                List lista =  DBUtilis.numeclienti(conn,marca);
                ...
                session.setAttribute("objective_name_clienti",ob_name);
