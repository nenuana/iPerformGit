...
@WebServlet(
        urlPatterns = {"/doDeleteFinanciar"}
)
public class DoDeleteFinanciar extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DoDeleteFinanciar() {
    }
            ...
            try {
                ...
                try {
                    ...
                    while (j.hasNext()) {
                        ...
                        String IDD = String.valueOf(jj.getID());
                        iduri.add(IDD);
                ...
                try {
                    DBUtilis.deleteObiectivFinanciar(conn, marca, IDP);
                    DBUtilis.deleteObiectivFinanciar(conn, marca, IDP2);
                    DBUtilis.deleteObiectivFinanciar(conn, marca, IDP3);
                    DBUtilis.deleteObiectivFinanciar(conn, marca, IDP4);
                ...
                session.setAttribute("objective_name",ob_name);
